            ...
            <ul class="space-y-2">
              ${this.expenses[category]
                  ...
                  <li class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    ...
                    <button class="bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600" onclick="expenseTracker.removeExpense('${category}', ${expense.id
                            })">Remove</button>
                  </li>
                `
                    )
...
document
    .getElementById("addExpenseForm").addEventListener("submit", function (e) {
        e.preventDefault();
